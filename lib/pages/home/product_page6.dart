...
class ProductPage6 extends StatefulWidget {
  ...
  @override
  State<ProductPage6> createState() => _ProductPageState();
}

class _ProductPageState extends State<ProductPage6> {

  openwhatsapp() async{
    var whatsapp ="+6285172147256";
    var whatsappURl_android = "https://api.whatsapp.com/send?phone="+whatsapp+"&text=Hallo saya ingin pesan produk snack dari toko hikmah";
  ...
  List images = [
    ...
    'assets/toko_hikmah2.jpeg',
    'assets/toko_hikmah3.jpeg',
  ];
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Toko snack yang ada di pasar gede bage bandung, dengan beralamat jl cijati sebelah tukang lotek',
                    style: secondgreyText.copyWith(
                      fontWeight: light,
                    ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'jl cijati sebelah tukang lotek',
                    style: secondgreyText.copyWith(
                      fontWeight: light,
                    ),
                  ),
