...
class ProductPage2 extends StatefulWidget {
  ...
  @override
  State<ProductPage2> createState() => _ProductPageState();
}
...
class _ProductPageState extends State<ProductPage2> {
  ...
  openwhatsapp() async{
    ...
    var whatsappURl_android = "https://api.whatsapp.com/send?phone="+whatsapp+"&text=Hallo saya ingin pesan produk jeans dari jeans cargo";
  ...
  List images = [
    ...
    'assets/toko_jeans_cargo2.jpeg',
    'assets/toko_jeans_cargo3.jpeg',
  ];
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Toko jeans yang ada di pasar gede bage bandung, dengan beralamat blok 219 - 221',
                    style: secondgreyText.copyWith(
                      fontWeight: light,
                    ),
